...
/// <summary>
/// Episode extractor specific to Apache Torrent website
/// </summary>
public class ApacheTorrentEpisodeExtractor : BaseEpisodeExtractor
{
    public ApacheTorrentEpisodeExtractor(
        ILogger<ApacheTorrentEpisodeExtractor> logger,
